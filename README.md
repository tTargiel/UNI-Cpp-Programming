...
- [zadanie_1.cpp - Singly linked list implementation (all three exercises devoted to this topic)](https://github.com/tTargiel/UNI-Cpp-Programming/blob/main/Lista%2003/zadanie_1.cpp)  
- [zadanie_1.cpp - * operator overloading, such that it returns dot product of two std::vector<double> objects](https://github.com/tTargiel/UNI-Cpp-Programming/blob/main/Lista%2004/zadanie_1.cpp)  
- [zadanie_2.cpp - Find roots with bisection method](https://github.com/tTargiel/UNI-Cpp-Programming/blob/main/Lista%2004/zadanie_2.cpp)  
